    ...
    <div class="max-w-7xl mx-auto px-5 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
            <div class="modern-card p-8 group reveal">
                <div class="w-16 h-16 rounded-2xl bg-primary/10 text-primary flex items-center justify-center text-3xl group-hover:bg-primary group-hover:text-white transition">
    ...
    <div class="max-w-7xl mx-auto px-5 lg:px-8">
        ...
        <div class="grid md:grid-cols-4 gap-6">
            <div class="modern-card p-8 text-center">
                <div class="text-5xl font-bold text-primary">01</div>
                <h3 class="mt-5 text-xl font-bold">Consult</h3>
            </div>
            <div class="modern-card p-8 text-center">
                <div class="text-5xl font-bold text-primary">02</div>
                <h3 class="mt-5 text-xl font-bold">Plan</h3>
            </div>
            <div class="modern-card p-8 text-center">
                <div class="text-5xl font-bold text-primary">03</div>
                <h3 class="mt-5 text-xl font-bold">Deliver</h3>
            </div>
            <div class="modern-card p-8 text-center">
                <div class="text-5xl font-bold text-primary">04</div>
                <h3 class="mt-5 text-xl font-bold">Support</h3>
            </div>
        </div>
    </div>
</section>
