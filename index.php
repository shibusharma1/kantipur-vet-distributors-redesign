...
<section class="homepage-banner relative overflow-hidden">
    ...
    <!-- Content -->
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-40 pb-24">
            ...
            <div class="blog-card reveal group">
                ...
                <div class="mt-5">
                    ...
                    <a
                        ...
                        class="inline-flex items-center gap-3 mt-6 text-secondary font-semibold hover:gap-4 transition-all duration-300">
